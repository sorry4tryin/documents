...
- 1.e.1.b
		$\begin{align}\begin{matrix}\text{outcome}~\rightarrow&o_{1}&o_{2}&o_{3}&o_{4}&o_{5}&o_{6}&o_{7}&o_{8}&o_{9}\\\text{utility function \downarrow}\\ 3\end{matrix}\end{align}$