...
- 1.e.1:
		$I= {1,2}~( \text{Let Antonia be player 1 and Bob player 2})$ 
		$\begin{matrix}S_{1}=(2,4,6)\\S_{2}=(1,3,5)\\S=S_{1}*S_{2}\\=&(1,2)&(1,4)&(1,6)&(3,2)&(3,4)&(3,6)&(5,2)&(5,4)&(5,6)\\&o_{1}&o_{2}&o_{3}&o_{4}&o_{5}&o_{6}&o_{7}&o_{8}&o_{9}\end{matrix}$
