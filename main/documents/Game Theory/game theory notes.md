...
- *game-frame*: a table of player strategies we have no information about regarding the preferences of the players
 ...
 1.e.1.a
Suppose we have two players: let Antonia be player 1 and Bob player 2: $I = \{ 1,2, \dots, n\}$. Antonia represents values $2,4,6$ and Bob represents values $1,3,5$: $S_{1}=\{ 2,4,6 \}$ and $S_{2}=\{ 1,3,5 \}$.  Combine the following, where $S$ serves as $f(s_{1},s_{2})$ and each function corresponds with a outcome ($o_{n}$): 
$$
...
\end{array}
$$
Suppose $5≥ x$ is Mexican ($M$), $7=x$ is Italian ($I$), and $9<x$ is Japanese ($J$):
$$
\begin{array}{|c|c|c|c|c|c|c|c|c|}
\hline
M & M & I & M & I & J & I & J & J \\
